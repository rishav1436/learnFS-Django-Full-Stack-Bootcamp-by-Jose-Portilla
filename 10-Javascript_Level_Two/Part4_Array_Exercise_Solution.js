...
response = prompt("Would you like to start the roster web app? y/n")
// Now create a while loop that keeps asking for an action (add,remove, display or quit)
if (response.toLowerCase() === "y") {
    while (response.toLowerCase() !== "quit") {
        response = prompt("Please select an action: add, remove, display, or quit.")

        if (response.toLowerCase() === "add") {
            addNew(prompt("What name would you like to add? "))
        } else if (response.toLowerCase() === "remove") {
            remove(prompt("What name would you like to remove? "))
        } else if (response.toLowerCase() === "display") {
            display()
        }
    }
